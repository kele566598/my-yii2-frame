...
StaticService::includeJsStatic('/group/js/member/index.js',\app\assets\AdminLteAsset::className());
?>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <form class="form-inline wrap_search">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a class="btn btn-primary pull-right" href="<?= \app\common\services\UrlService::buildGroupUrl('/member/create')?>"> <i class="fa fa-plus"></i> 添加组织用户 </a>
                </div>
            </div>
        </form>
            ...
            <?php else: ?>
                <?php foreach($models as $model):?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= UrlService::buildGroupUrl('/member/view',['id'=>$model->id]) ?>"> 查看 </a>
                            <a href="<?= UrlService::buildGroupUrl('/member/update',['id'=>$model->id]) ?>"> 编辑 </a>
