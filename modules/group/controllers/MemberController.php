...
class MemberController extends BaseGroupController
{
    public function actionIndex(){
        ...
        $query = Member::find()->where(['role'=>Member::ROLE_USER]);
    ...
    public function actionCreate(){
        ...
        $model = new Member();
        $model->setScenario('group-create');
    ...
    public function actionUpdate(){
        ...
        $model->setScenario('group-update');
        $model->load(Yii::$app->request->post());
